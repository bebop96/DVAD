...
class cfg(cfg_common, cfg_dataset_default, cfg_model_mambaad):
	...
	def __init__(self):
		...
		# self.test_per_epoch = self.epoch_full // 100
		...
		self.model_t.kwargs = dict(pretrained=False, checkpoint_path='model/pretrain/resnet34-b627a593.pth',
		...
		self.model.name = 'mambaad' # /root/autodl-tmp/ADer-main/runs/MAMBAADTrainer_configs_mambaad_mambaad_mvtec_20250107-180515/net_80.pth
		# self.model.kwargs = dict(pretrained=True, checkpoint_path='/root/autodl-tmp/ADer-main/runs/MAMBAADTrainer_configs_mambaad_mambaad_mvtec_20250107-211445/net_120.pth', strict=True, model_t=self.model_t,
		# 						 model_s=self.model_s)
		self.model.kwargs = dict(pretrained=True, checkpoint_path='/root/autodl-tmp/ADer-main/cache/mambaad_mvtec_net_450.pth', strict=True, model_t=self.model_t,
								 model_s=self.model_s)
